# This Makefile is for the Net::MQ extension to perl.
#
...
#     VERSION_FROM => q[lib/Net/MQ.pm]
#     clean => { FILES=>q[Net-MQ-*] }
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Net-MQ' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Net-MQ",' >> META_new.json
